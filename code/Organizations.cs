...
namespace Roleplay{
    ...
    public partial class Org : BaseNetworkable{
        ...
        public static bool AddToOrg(Org o, int CharacterID){
            if(o != null && CharacterID !=0){
            if(GetOrg(null, CharacterID)==null){
            foreach(Client cl in Client.All){
                if ((cl.Pawn as Citizen).characterid == CharacterID){
                    (cl.Pawn as Citizen).org = o;
                   
                }

            }
            
             o.Members.Add(CharacterID);
             SaveOrgs();
            return true;
            }}
        ...
        public static void SaveOrgs(){
            ...
            foreach(Org o in (Game.Current as RoleplayGame).AllOrgs){
                ...
                foreach(int i in o.Members){
    
                    mems.Add(i);
                }
                orgs.AllOrgs.Add(new OrgData(){Name = o.Name, OrgID = o.OrgID, LeaderID = o.LeaderID, Members = mems});
