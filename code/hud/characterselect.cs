...
namespace Roleplay{
    public class CharacterSelectPage:Panel{
        ...
        public static void AddCharacter(Citizen ci){
            characterpanel cpan = new characterpanel(ci.characterid, ci.Name, ci.balance, ci.orgname);
    ...
    public class characterpanel:Button{
        ...
        public characterpanel(int cid, string n, int b, string orgname){
        characterid = cid;
        Name = n;
        balance = b;
        OrgName = orgname;
        ...
        OrgNameLabel.AddClass("orgnamelabel");
